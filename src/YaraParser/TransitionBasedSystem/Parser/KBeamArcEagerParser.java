...
public class KBeamArcEagerParser extends TransitionBasedParser {
    ...
    public KBeamArcEagerParser(ArrayList<Integer> dependencyRelations,MLPNetwork network,
    ...
    public static Configuration parseNeural(final MLPNetwork nn, Sentence sentence, boolean rootFirst,
    ...
    private static void parseNeuralWithOneThread(final MLPNetwork nn, ArrayList<Configuration> beam,
    ...
    public static void parseNNConllFileNoParallel(final MLPNetwork nnInf, String inputFile, String outputFile,
        ...
        while (true) {
            ...
            for (GoldConfiguration goldConfiguration : data) {
                ...
                bestParse = parseNeural(nnInf, goldConfiguration.getSentence(), options.rootFirst, maps,
                        dependencyLabels, beamWidth);
    ...
    public void parseConllFileParallel(String inputFile, String outputFile, boolean rootFirst, int beamWidth, boolean
        ...
        while (true) {
            ...
            for (GoldConfiguration goldConfiguration : data) {
                ParseThread thread = new ParseThread(index, network, dependencyRelations, featureLength,
